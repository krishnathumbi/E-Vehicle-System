...
//echo "select * from reservation where carNo='$carNo' and reserdate BETWEEN '$sdatee' AND '$edatee' and   	returndate BETWEEN '$sdatee' AND '$edatee'";
$query=mysql_query("select * from reservation where carNo='$carNo' and reserdate <= '$sdatee' and returndate >= '$edatee'");
