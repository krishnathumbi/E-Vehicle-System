...
mysql_query("INSERT INTO branchregistration(branchname,branchaddress,branchcity,branchstate,branchemail,branchPhone,status)
value('$com_name','$com_addrs','$com_city','$com_state','$com_email','$com_phone','pending')");
