...
<tr><td>Branch name</td><td><input name="com_name" type="text" class="required"></td></tr>
...
<tr><td>Email</td><td><input name="com_email" type="email" class="required frm_cntrl" style="margin-left: 113px;"></td></tr>
<tr><td>Phone</td><td><input name="com_phone" type="text" class="number" maxlength="10" minlength="7"></td></tr>
