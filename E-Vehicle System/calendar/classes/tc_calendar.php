...
class tc_calendar{
	...
	function writeDateContainer(){
		...
		echo("<span id=\"divCalendar_".$this->objname."_lbl\" class=\"date-tccontainer required\"".($this->rtl ? " dir=\"rtl\"" : "").">$dd</span>");
		echo("<input type=\"hidden\" class=\"myfunction_".$this->objname."_lbl date-tccontainer required\" value='".$dd."' />");
	}
