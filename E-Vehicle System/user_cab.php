...
<tr>
	...
	<tr><td>Journey Date</td><td><input type="date" name="dt" class="frm_cntrl"/></td></tr>
	
	
	
	<!--<tr><td>Can you share this vehicle for pooling</td><td><input type="checkbox" name="vehicle"/>-->
	<br>
	</td></tr>
	...
	<tr><td colspan="2">
<input name="btn_book" type="submit" value="Search">
