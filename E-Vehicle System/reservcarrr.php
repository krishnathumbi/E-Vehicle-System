...
$carId=$_GET['id'];
$dbh=new dbi(); 
$sql=mysql_query("select * from cars where RefId='".$carId."'");
...
<div>Advance <input type="text" value="0" name="paymentadvance" style="width:50px !important;" onfocus="settotal();" onchange="setbalance();"  class="paymentadvance" /></div>
...
<input type="hidden" name="carnumberIndex" class="carnumberIndex" value="<?php echo $result->RefId;?>" />
</form>
</div>
<?php
include('footer.php');
