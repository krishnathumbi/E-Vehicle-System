...
$waitingcarr=$_POST['waitingcars'];
if($waitingcarr<=0)
{
$sql=mysql_query("INSERT INTO `carrent`.`reservation` (`rentid`,`userid`, `carid`, `cartype`, `noofcar`, `rdate`, `edate`, `noofdays`, `totalamount`,`waitingstatus`)  VALUES (NULL,'$userId','$yy','$new1','$typeno','$rdate','$edate','$noofdays','$totalamount','$waitingcarr'
)");
         if($sql)
		{ 
...
{
	$sql=mysql_query("INSERT INTO `carrent`.`reservation` (`rentid`,`userid`, `carid`, `cartype`, `noofcar`, `rdate`, `edate`, `noofdays`, `totalamount`,`waitingstatus`)  VALUES (NULL,'$userId','$yy','$new1','$typeno','$rdate','$edate','$noofdays','$totalamount','0')");
